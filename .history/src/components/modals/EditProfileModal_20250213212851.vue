            ...
            <div>
              ...
              <div class="mt-1 flex gap-2">
                <input
                  ...
                  class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#6C47FF] focus:border-[#6C47FF]"
                />
                <button
                  v-if="isEmailChanged"
                  type="button"
                  @click="verifyEmail"
                  :disabled="isEmailVerifying"
                  class="px-4 py-2 bg-[#6C47FF] text-white rounded-md hover:bg-[#5835FF] disabled:bg-gray-400"
                >
                  인증
                </button>
              </div>
