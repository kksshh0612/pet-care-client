<template>
  <div class="min-h-screen bg-gradient-to-b from-[#F3F0FF]/30 to-white">
    ...
    <button 
      @click="toggleSidebar"
      class="fixed top-20 left-4 p-2 bg-white rounded-lg shadow-lg hover:bg-gray-50 lg:hidden z-50"
    >
    ...
    <!-- 메인 컨텐츠 -->
    <main :class="['pt-24 min-h-screen transition-all duration-300', isSidebarOpen ? 'lg:ml-64' : '']">
